...
public class MagazinesController extends SampleController implements Initializable { 
	...
	@FXML 
    private void ClickedObama(MouseEvent event) throws IOException { 
    ...
    private void ClickedRight1() throws IOException { 
			...
			Pane root = (Pane)FXMLLoader.load(getClass().getResource("Magazine2.fxml"));
			rootpane.getChildren().setAll(root);
    ...
    private void fillComboBox(){
        categories.getItems().addAll("News", "Science","Sociétale","BD");
    }
